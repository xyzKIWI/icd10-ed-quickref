...
// ===== 骨折快捷 chips(2026-08-25 MVP：腕/髖/踝/足/胸五區，Kiwi 拍板) =====
// 小人圖點「骨折+部位」後顯示的常用精確碼快選。每顆 chip=[中文短標,{R:右碼,L:左碼,U:未明側碼}]，
// 碼=官方 billable stem(不含第7碼，顯示時自動補 A 初期照護)。排序原則=unspecified 保底優先(Kiwi 定)，
// 該段無未明型碼時(如踝/粗隆間只有移位/非移位二分)才列型態對。碼全數經官方表逐一驗證(chipsGuard 守門)。
const FRACTURE_CHIPS = {
  wrist:[
    ["橈骨遠端(未明型)",{R:"S52.501",L:"S52.502",U:"S52.509"}],
    ["Colles' 骨折",{R:"S52.531",L:"S52.532",U:"S52.539"}],
    ["Smith's 骨折",{R:"S52.541",L:"S52.542",U:"S52.549"}],
    ["尺骨遠端(未明型)",{R:"S52.601",L:"S52.602",U:"S52.609"}],
    ["舟狀骨(未明部位)",{R:"S62.001",L:"S62.002",U:"S62.009"}],
    ["腕骨(未明)",{R:"S62.101",L:"S62.102",U:"S62.109"}],
  ],
  hip:[
    ["股骨頸(未明部位)",{R:"S72.001",L:"S72.002",U:"S72.009"}],
    ["粗隆部(未明)",{R:"S72.101",L:"S72.102",U:"S72.109"}],
    ["粗隆間·移位",{R:"S72.141",L:"S72.142",U:"S72.143"}],
    ["粗隆間·非移位",{R:"S72.144",L:"S72.145",U:"S72.146"}],
    ["粗隆下·移位",{R:"S72.21",L:"S72.22",U:"S72.23"}],
    ["粗隆下·非移位",{R:"S72.24",L:"S72.25",U:"S72.26"}],
  ],
  ankle:[
    ["外踝·移位",{R:"S82.61",L:"S82.62",U:"S82.63"}],
    ["外踝·非移位",{R:"S82.64",L:"S82.65",U:"S82.66"}],
    ["內踝·移位",{R:"S82.51",L:"S82.52",U:"S82.53"}],
    ["內踝·非移位",{R:"S82.54",L:"S82.55",U:"S82.56"}],
    ["雙踝·移位",{R:"S82.841",L:"S82.842",U:"S82.843"}],
    ["三踝·移位",{R:"S82.851",L:"S82.852",U:"S82.853"}],
  ],
  foot:[
    ["第5蹠骨·移位",{R:"S92.351",L:"S92.352",U:"S92.353"}],
    ["第5蹠骨·非移位",{R:"S92.354",L:"S92.355",U:"S92.356"}],
    ["蹠骨(未明)",{R:"S92.301",L:"S92.302",U:"S92.309"}],
    ["跟骨(未明型)",{R:"S92.001",L:"S92.002",U:"S92.009"}],
    ["腳趾(未明)",{R:"S92.911",L:"S92.912",U:"S92.919"}],
    ["大趾·移位",{R:"S92.401",L:"S92.402",U:"S92.403"}],
  ],
  chest:[
    ["單根肋骨",{R:"S22.31",L:"S22.32",U:"S22.39"}],
    ["多根肋骨",{R:"S22.41",L:"S22.42",U:"S22.49"}],
    ["連枷胸",{U:"S22.5"}],
    ["胸骨(未明部位)",{U:"S22.20"}],
    ["胸骨體",{U:"S22.22"}],
  ],
